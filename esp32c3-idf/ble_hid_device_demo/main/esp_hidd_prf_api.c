...
void esp_hidd_send_mouse_value(uint16_t conn_id, uint8_t mouse_button, int8_t mickeys_x, int8_t mickeys_y, int8_t mickeys_w)
{
    ...
    buffer[3] = mickeys_w;           // Wheel
    buffer[4] = 0;           // AC Pan

    // buffer[0] = mouse_button;   // Buttons
    // buffer[1] = 0;           // X
    // buffer[2] = 0;           // Y
    // buffer[3] = mickeys_x;           // Wheel
    // buffer[4] = mickeys_y;           // AC Pan
